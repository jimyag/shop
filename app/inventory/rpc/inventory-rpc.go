...
import (
	...
	"github.com/jimyag/shop/app/inventory/rpc/handler"
	"github.com/jimyag/shop/app/inventory/rpc/initialize"
...
func main() {
	...
	inventoryServer := handler.NewInventoryServer(sqlStore)
	proto.RegisterInventoryServer(grpcServer, inventoryServer)
